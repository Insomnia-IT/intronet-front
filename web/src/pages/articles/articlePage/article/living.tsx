...
const Footer = () => (
  <>
    <div flex column gap="4">
      <div class="sh2" style={{ marginTop: 8 }}>
        Очень важно, прочитайте:
      </div>
      <Link goTo="/articles/eco" style={{ margin: "8px 0" }}>
        экологические правила
      </Link>
      <Link goTo="/articles/fire" style={{ margin: "4px 0px 8px" }}>
        пожарная безопасность
      </Link>
      <div>
        Будьте осторожны: в лесах может попадаться колючая проволока и другие
