  ...
  fun: {
    ...
    component: () => (
      <div class="text colorMediumBlue" flex column gap="4">
        <div>
          Этим летом Детская поляна превращается в театральные подмостки. В
          программе спектакли наших старых друзей и новых коллективов, шоу
          иллюзий и, конечно мультики по вечерам. А волшебники-мастера научат
          разным фокусам и трюкам, которые будут интересны детям и взрослым.
        </div>
        <div>
          Дети не останутся без вкусной еды, на детской поляне работает уютное
          кафе «Глаз да глаз».
        </div>
        <Link goTo={["map", { name: "глаз да глаз" }]}>кафе на карте</Link>
        <div class="sh2" style={{ marginTop: 15 }}>
          Развлечения днём
        </div>
        <div>
          Интересные лекции, увлекательные мастер-классы и игры в детском шатре.
        </div>
        <Link goTo={["activities", { name: "детский сад" }]}>
        ...
        <Link goTo={["map", { name: "детский экран" }]}>
          детский экран на карте
        </Link>
        <div style={{ marginTop: 15 }}>
          В Диафильминариуме ночью показ редчайших диафильмов с живым
          озвучанием.
        </div>
        <Link goTo={["map", { name: "диафильминариум" }]}>
          диафильминариум на карте
        </Link>
        <div style={{ marginTop: 15 }}>
          На основных экранах первым блоком идет анимация, рассчитанная на
          семейный просмотр.
        </div>
    ...
    component: () => (
      <div class="text colorMediumBlue" flex column gap="5">
        <div>
          ...
          которая поможет в случае потери ребёнка.
        </div>
