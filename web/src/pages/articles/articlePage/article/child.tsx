...
const sections = {
  fun: {
    title: "Развлечения", component: () => <div class="text colorMediumBlue" flex column gap="4">
      <div>Детская поляна - пространство для гостей и детей. Здесь десятки мастер-классов, спектакли и концерты,
         тематические лекции о детско-родительских отношениях, тренинги и танцы, йога по утрам и релаксация
          под звуки гонгов по вечерам. И, конечно, мультфильмы на Детском экране.</div>
