...
export function Animation() {
  ...
  return <PageLayout title='Программа показов'>
    ...
    <div>
      ...
      <div class="text colorTDarkDisabled" style={{margin: '16px 0 24px'}}>
    ...
    <Card border="Vivid" onClick={() => router.goTo(['voting'])}>
      <h2 style={{margin: 0}}>Международный конкурс анимации</h2>
      <div class="text colorTDarkDisabled" style={{margin: 0}}>Приз зрительских симпатий</div>
    </Card>
