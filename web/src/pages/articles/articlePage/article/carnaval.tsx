...
export function Carnaval() {
  return <PageLayout title='Карнавал'>
    ...
    <div class="text colorMediumBlue">Вечером субботы, 19 июля в 18:00, по всей территории фестиваля пройдет костюмированное шествие под живую музыку,
      с барабанами и трубами.</div>
    <div class="text colorMediumBlue">Присоединяйтесь, старт у тЯтра!</div>
  </PageLayout>
}
