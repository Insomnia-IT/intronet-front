  ...
  wc: {
    ...
    component: () => (
      <div class="text" flex column gap="4">
        ...
        <div>
          Раз в день мы проводим санитарную обработку кабинок мойками высокого
          давления и засыпаем ямы специальными средствами от запаха.
        </div>
        ...
        <ButtonsBar at="bottom">
          <Button
            type="blue"
            class="w-full"
            goTo={["map", { direction: Directions.wc }]}
          >
            к туалетам
          </Button>
        </ButtonsBar>
