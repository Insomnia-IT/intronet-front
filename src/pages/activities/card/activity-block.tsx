      ...
      <div className={ Styles.activityContainer } flex column gap>
        <div flex class={ Styles.headerContainer }>
          <div flex column style={ 'gap: 8px' }>
            ...
            <div className={ [ activity.isCanceled ? Styles.headerCanceled : Styles.header, "sh1" ].join(" ") }>
        ...
        <div className={ `${ Styles.activityTimePlace } sh3` }>
          <span
            className={ activity.isCanceled ? Styles.activityPlaceCanceled : Styles.activityPlace }>
            { locationsStore.getName(activity?.locationId) }
          </span>

          <span
            className={ activity.isCanceled ? Styles.activityTimeCanceled : Styles.activityTime }>{ coerceTime(activity.start) } - { coerceTime(activity.end) }</span>
        </div>
      </div>
    </Card>
  );
