...
import {Button, Card, Columns, Heading, Icon, Image} from "react-bulma-components";
  ...
  return <Card>
    <Card.Content>
      <Columns>
        ...
        <Columns.Column>
          <Heading onInput={e => props.onChange({
            ...props.location,
        ...
        <Columns.Column size={1}>
            <Icon size="large" className="mdi mdi-arrow-down-bold" >
            </Icon>
        </Columns.Column>
      </Columns>
    </Card.Content>
