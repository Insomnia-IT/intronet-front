...
const sections = {
  about: {
    title: "О портале", component: () => <div class="text colorMediumBlue" flex column gap="4">
      ...
      <div>На фестивале все быстро меняется. Чтобы быть в курсе изменений, рекомендуем иногда подключаться к сети и
        открывать приложение, чтобы обновить данные.
      </div>
    </div>
  }, fast: {
...
const ThreePoint = () => <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
  ...
  <path
    ...
    stroke="#F7FCFF" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/>
</svg>;
