...
export const Cancel = (props: React.JSX.HTMLAttributes<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" width="24" height="24"  focusable="false" className="chakra-icon css-1t2o3o1">
